...
class TestCard(unittest.TestCase):
    ...
    def test_q2(self):
        ...
        '''
        c3 = hw5_cards.Card(1, 1)
        self.assertEqual(c3.suit_name, "Clubs")

        return c3.suit_name,'Clubs'
    ...
    def test_q3(self):
        ...
        '''
        c3 = hw5_cards.Card(3, 13).__str__()
        self.assertEqual(c3,"King of Spades")
        return c3, 'King of Spades'
    ...
    def test_q5(self):
        ...
        self.assertIsInstance(c5,hw5_cards.Card)

        return c5,hw5_cards.Card
    ...
    def test_q7(self):
        ...
        deck = hw5_cards.Deck()
        c7 = deck.deal_card()
        deck.replace_card(c7)
        self.assertEqual(len(deck.cards),52)


        return 51+1, (len(deck.cards)), 52
    ...
    def test_q8(self):
        ...
        '''
        deck = hw5_cards.Deck()
        d8 = deck.replace_card(deck.cards[44])
